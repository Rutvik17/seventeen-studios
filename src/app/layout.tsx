...
export const metadata: Metadata = {
  ...
  */
  ...share({
    ...
    path: '/',
    image: 'home',
    alt: `A watercolour of Nvidia's Voyager and Endeavor buildings in Santa Clara in autumn, with the maple leaf mark and ${founder.name}'s name signed in paint in the corner`,
  }),
